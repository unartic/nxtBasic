...
The ADDSPRITE function loads a sprite from a file into VRAM and configures it.

**Syntax:**

    ADDSPRITE file, width, height, colordepth, paletteoffset
    
- file: The name of the file containing the sprite image.
- width: The width of the sprite in pixels.
- height: The height of the sprite in pixels.
- colordepth: The number of colors used in the sprite (e.g., 2, 4 or 8 bits per pixel).
...
**Syntax:**
    ...
    width = GETBMXWIDTH(filename, device)

- filename: The name of the BMX file.
- device: The device from which to get the file.

**Example:**

    width = GETBMXWIDTH("image.bmx", 8)
...
**Syntax:**
    ...
    height = GETBMXHEIGHT(filename, device)
...
**Example:**
    ...
    height = GETBMXHEIGHT("image.bmx", 8)
...
**Syntax:**
    ...
    SAVEBMX filename, device, x, y, width, height

- filename: The name of the BMX file to save.
- device: The device to which to save the file.
...
**Example:**
    ...
    SAVEBMX "snapshot.bmx", 8, 0, 0, 320, 200
...
**Syntax:**
    ...
    VLOAD filename, device, verabank,address
...
**Syntax:**
    ...
    BVLOAD filename, device, verabank,address
